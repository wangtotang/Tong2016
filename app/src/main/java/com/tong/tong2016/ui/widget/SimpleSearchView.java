package com.tong.tong2016.ui.widget;
...
public class SimpleSearchView extends LinearLayout {
    ...
    private ImageView ivSearch,mClearTextButton;
    ...
    private Runnable mShowImeRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (imm != null) {
                HIDDEN_METHOD_INVOKER.showSoftInputUnchecked(imm, SimpleSearchView.this, 0);
            }
        }
    };
    ...
    public SimpleSearchView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SimpleSearchView, defStyle, 0);

        mQueryHint = a.getString(R.styleable.SimpleSearchView_query_hint);

        a.recycle();

        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.view_simple_search, this, true);
        ...
        setFocusable(true);//使用代码设置focusable，可立即获得焦点
    ...
    protected void onTextFocusChanged() {
        updateViewsVisibility();
        postUpdateFocusedState();
    ...
    private void updateFocusedState() {
        ...
        ivSearch.getDrawable().setState(focused ? FOCUSED_STATE_SET : EMPTY_STATE_SET);
        invalidate();
    }
    ...
    private CharSequence getDecoratedHint(CharSequence hintText) {
        ...
        ssb.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.colorTextNormal)),
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView {
        ...
        void setSearchView(SimpleSearchView searchView) {
